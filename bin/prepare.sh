...
if [ $JAR_FILE == 'my.jar' ] ;
        then
                if [ `ls $SERVER_DIR/jars | wc -l` -gt 0 ];
                        then echo "huzzah files";
                        else
...
if [ $JAR_FILE == 'minecraft_server.jar' ] ;
        then
        cp $JAR_DIR/minecraft_server.jar $SERVER_DIR/minecraft_server.jar;
        else
        echo "You did not choose Vanilla Minecraft";
fi
if [ $JAR_FILE == 'BungeeCord.jar' ] ;
        then
	if [ `ls $SERVER_DIR/config.yml | wc -l` -gt 0 ];
	then echo "They already have a config.yml";
	else
...
if [ $JAR_FILE == 'FTB.jar' ] ;
        then
		if [ `ls $SERVER_DIR/FeedTheBeast | wc -l` -gt 0 ];
		        then echo "huzzah files";
		        else
...
if [ $JAR_FILE == 'Dire.jar' ] ;
        then
		if [ `ls $SERVER_DIR/Dire | wc -l` -gt 0 ];
		        then echo "huzzah files";
		        else
...
if [ $JAR_FILE == 'MindCrack.jar' ] ;
	then
		if [ `ls $SERVER_DIR/MindCrack | wc -l` -gt 0 ];
		        then echo "huzzah files";
		        else
...
if [ $JAR_FILE == 'voltz.jar' ] ;
        then
                if [ `ls $SERVER_DIR/Voltz | wc -l` -gt 0 ];
                        then echo "huzzah files";
                        else
...
if [ $JAR_FILE == 'tekkit.jar' ] ;
        then
                if [ `ls $SERVER_DIR/Tekkit | wc -l` -gt 0 ];
                        then echo "huzzah files";
                        else
...
if [ $JAR_FILE == 'tekkitbigdig.jar' ] ;
        then
                if [ `ls $SERVER_DIR/Tekkit_BigDig | wc -l` -gt 0 ];
                        then echo "huzzah files";
                        else
...
if [ $JAR_FILE == 'tekkitclassic.jar' ] ;
	then
		if [ `ls $SERVER_DIR/Tekkit_Classic | wc -l` -gt 0 ];
		        then echo "huzzah files";
		        else
...
if [ $JAR_FILE == 'tekkit_lite.jar' ] ;
	then
		if [ `ls $SERVER_DIR/Tekkit_Lite | wc -l` -gt 0 ];
        		then echo "huzzah files";
		        else
...
if [ $JAR_FILE == 'tshock.jar' ] ;
	then
		if [ `ls $SERVER_DIR/TShock | wc -l` -gt 0 ];
        		then echo "huzzah files";
		        else
...
if [ $JAR_FILE == 'teamspeak.jar' ] ;
	then
		if [ `ls $SERVER_DIR/TeamSpeak3 | wc -l` -gt 0 ];
		        then echo "huzzah files";
		        else
...
if [ $JAR_FILE == 'tf2.jar' ] ;
	then 
		if [ `ls $SERVER_DIR/Steam | wc -l` -gt 0 ];
	        then echo "huzzah files";
	        else
...
if [ $JAR_FILE == 'mumble.jar' ] ;
	then
		if [ `ls $SERVER_DIR/Mumble | wc -l` -gt 0 ];
        		then echo "huzzah files";
	        	else
